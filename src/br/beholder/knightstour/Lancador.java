...
import br.beholder.knightstour.ui.window.ComponentResizer;
import br.beholder.knightstour.ui.window.OutsidePanel;
    ...
    private void start() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Image icon;
                try {
                    icon = ImageIO.read(getClass().getResource("/br/beholder/knightstour/ui/resources/icon.png"));
